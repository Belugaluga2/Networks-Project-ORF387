"""
Express Pass participation sweep WITH ALL AGENT BEHAVIORS ENABLED.

Same as express_sweep.py but agents have all 5 imperfect behaviors active
...
Output: figures/behaviors_express_sweep.png and behaviors_express_sweep_results.csv.
"""
...
def main():
    print(f"Running {len(PARTICIPATION_LEVELS)} Express Pass sweep simulations "
    ...
    # Save CSV
    csv_path = Path(__file__).parent / "behaviors_express_sweep_results.csv"
    ...
    out = FIG_DIR / "behaviors_express_sweep.png"
